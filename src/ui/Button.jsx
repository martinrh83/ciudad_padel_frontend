export default function Button({
  ...
  return (
    <button
      type={type}
      className={`relative inline-block text-lg mx-2  ${
        isDisabled ? "opacity-50" : "group"
      }`}
      onClick={handleOnClick}
      disabled={isDisabled}
    >
      <span className="relative z-10 block px-5 py-3 overflow-hidden font-bold leading-tight text-slate-900 transition-colors duration-300 ease-out border-2 border-slate-900 rounded-lg group-hover:text-lime-400 uppercase">
